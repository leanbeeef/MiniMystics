...
export function CardTile({ definitionId, level, selected, compact, onClick, footer }: { definitionId: string; level?: number; selected?: boolean; compact?: boolean; onClick?: () => void; footer?: React.ReactNode }) {

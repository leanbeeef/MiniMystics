...
export const PACK_DEFINITIONS = [
  {
    ...
    name: "Standard Pack",
    description:
      "Five Mystic cards at standard odds, with a chance of a bonus Handler or reward card.",
    cardCount: 5,
    coinPrice: 500,
    theme: "Standard",
    active: true,
    handlerChancePercent: 5,
    bonusRewardChancePercent: 25,
  },
  {
    id: "random-order",
    name: "Random Order Pack",
    description: "Five Mystics from one surprise Order.",
    cardCount: 5,
    coinPrice: 600,
    theme: "Order",
    active: true,
    handlerChancePercent: 0,
    bonusRewardChancePercent: 0,
  },
  {
    id: "order",
    name: "Order Pack",
    description: "Choose an Order. Draw five Mystics from it.",
    cardCount: 5,
    coinPrice: 800,
    theme: "Order",
    active: true,
  ...
  },
  {
    id: "handler",
    name: "Handler Pack",
    description: "One guaranteed Handler.",
    cardCount: 1,
    coinPrice: 500,
    theme: "Handler",
    active: true,
    handlerChancePercent: 100,
    bonusRewardChancePercent: 0,
  },
  {
    id: "apex",
    name: "Apex Pack",
    description: "One guaranteed Apex Mystic.",
    cardCount: 1,
    coinPrice: 15000,
    theme: "Apex",
    active: true,
...
export function weightedRarity(
  random = Math.random,
  weights = STANDARD_RARITY_WEIGHTS,
): Rarity {

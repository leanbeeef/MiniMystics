export const LOGO_ART = "/logo/logo.png";

export const REWARD_ART = {
  coins: "/art/rewards/coins.png",
  xp: "/art/rewards/xp.png",
  coinBoost: "/art/rewards/coin-boost.png",
  xpBoost: "/art/rewards/xp-boost.png",
} as const;
...
export const OPPONENT_ART: Record<string, string> = {
...
export const ALLEGIANCE_ART: Record<string, string> = {

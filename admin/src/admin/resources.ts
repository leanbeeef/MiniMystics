...
const specs: ResourceSpec[] = [
  ...
  { model: 'Campaign', section: 'Game Content', writeRoles: GAME_ADMINS, options: { actions: accessActions(GAME_ADMINS, true, GAME_ADMINS) } },
  { model: 'CampaignOpponent', section: 'Game Content', writeRoles: GAME_ADMINS, options: { actions: accessActions(GAME_ADMINS, true, GAME_ADMINS), listProperties: ['id', 'campaignId', 'stageNumber', 'name', 'difficulty', 'unlockLevel', 'active'] } },
